 ...
 * limitations under the License.
 */
const O=[[.41233895,.35762064,.18051042],[.2126,.7152,.0722],[.01932141,.11916382,.95034478]],j=[[3.2413774792388685,-1.5376652402851851,-.49885366846268053],[-.9691452513005321,1.8758853451067872,.04156585616912061],[.05562093689691305,-.20395524564742123,1.0571799111220335]],A=[95.047,100,108.883];function R(e,t,n){return(255<<24|(255&e)<<16|(255&t)<<8|255&n)>>>0}function T(e){return R(q(e[0]),q(e[1]),q(e[2]))}function N(e){return e>>16&255}function z(e){return e>>8&255}function F(e){return 255&e}function U(e,t,n){const r=j,o=r[0][0]*e+r[0][1]*t+r[0][2]*n,a=r[1][0]*e+r[1][1]*t+r[1][2]*n,i=r[2][0]*e+r[2][1]*t+r[2][2]*n;return R(q(o),q(a),q(i))}function B(e){const t=function(e){return L([H(N(e)),H(z(e)),H(F(e))],O)}(e)[1];return 116*W(t/100)-16}function D(e){return 100*_((e+16)/116)}function H(e){const t=e/255;return t<=.040449936?t/12.92*100:100*Math.pow((t+.055)/1.055,2.4)}function q(e){const t=e/100;let n=0;return n=t<=.0031308?12.92*t:1.055*Math.pow(t,1/2.4)-.055,r=0,o=255,(a=Math.round(255*n))<r?r:a>o?o:a;var r,o,a}function W(e){return e>216/24389?Math.pow(e,1/3):(903.2962962962963*e+16)/116}function _(e){const t=e*e*e;return t>216/24389?t:(116*e-16)/903.2962962962963}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
class ${constructor(e,t,n,r,o,a,i,s,l,c){this.n=e,this.aw=t,this.nbb=n,this.ncb=r,this.c=o,this.nc=a,this.rgbD=i,this.fl=s,this.fLRoot=l,this.z=c}static make(e=function(){return A}(),t=200/Math.PI*D(50)/100,n=50,r=2,o=!1){const a=e,i=.401288*a[0]+.650173*a[1]+-.051461*a[2],s=-.250268*a[0]+1.204414*a[1]+.045854*a[2],l=-.002079*a[0]+.048952*a[1]+.953127*a[2],c=.8+r/10,d=c>=.9?M(.59,.69,10*(c-.9)):M(.525,.59,10*(c-.8));let u=o?1:c*(1-1/3.6*Math.exp((-t-42)/92));u=u>1?1:u<0?0:u;const y=c,h=[u*(100/i)+1-u,u*(100/s)+1-u,u*(100/l)+1-u],p=1/(5*t+1),f=p*p*p*p,w=1-f,g=f*t+.1*w*w*Math.cbrt(5*t),v=D(n)/e[1],m=1.48+Math.sqrt(v),b=.725/Math.pow(v,.2),I=b,k=[Math.pow(g*h[0]*i/100,.42),Math.pow(g*h[1]*s/100,.42),Math.pow(g*h[2]*l/100,.42)],x=[400*k[0]/(k[0]+27.13),400*k[1]/(k[1]+27.13),400*k[2]/(k[2]+27.13)];return new $(v,(2*x[0]+x[1]+.05*x[2])*b,b,I,d,y,h,g,Math.pow(g,.25),m)}}$.DEFAULT=$.make();
/**
 * @license
 * Copyright 2021 Google LLC
 *
